  ...
  const generarFactura = async () => {
    ...
    if (!result.ok) {
      ...
      const messages: Record<string, string> = {
        ...
        no_se_pudo_reservar: "No se pudo reservar la facturación (falla temporal) — probá de nuevo en un momento",
        no_se_pudo_verificar: "No se pudo verificar si esta reserva ya estaba facturada — probá de nuevo antes de reintentar",
        error_inesperado: "Error inesperado del servidor al facturar — revisá en tu cuenta de AFIP antes de reintentar",
        monto_invalido: `El monto de esta reserva no es válido ($${order.monto}) — revisalo antes de facturar`,
